...
echo TH06-RL Lunatic / Reimu-A / Stage 5 focused learning loop
echo Physical HIT is recorded and recovered in the same complete Stage.
echo Create artifacts\pause-lunatic-stage5 to stop between complete stages.

:trial
if exist "%REPO%artifacts\pause-lunatic-stage5" (
