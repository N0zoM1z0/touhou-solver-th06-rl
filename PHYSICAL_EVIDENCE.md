...
| 2026-08-06 | Lunatic / Reimu-A / Stage 6 | `20260806T151806Z-653426100` | `ddd762f` | 12 | 6.579 ms | 0.0408% | complete optimized-native episode; 12/12 HIT preceded by empty Hard set; dense (500+ bullets) control P95 8.902 ms with 0 stale retries; full-decode Hard parity 60/60; 0 geometry/certificate candidates; 0 Bomb; 70 authoritative anchors; 309 MiB compressed corpus |
| 2026-08-06 | Lunatic / Reimu-A / Stage 6 | `20260806T153702Z-009110000` | `846b17f` | 19 | 6.740 ms | 0.0296% | complete first hierarchical-v3 episode; 19/19 HIT preceded by empty Hard set; dense (500+ bullets) control P95 10.181 ms, stale 0.257%; full-decode Hard parity 64/64; 0 geometry/certificate candidates; 0 Bomb; 89 authoritative anchors; 308 MiB compressed corpus |
| 2026-08-07 | Lunatic / Reimu-A / Stage 6 | `20260807T033012Z-128212400` | `bd26231` | 10 | 6.418 ms | 0.0514% | complete first physical hit-trace-v2 episode after logged-action replay; 10/10 HIT credited to recent same-phase actions; no in-Stage durability write; full-decode Hard parity 52/52; 0 unsafe/conservative divergence; 0 scope/integrity/infrastructure failures; committed policy update |
