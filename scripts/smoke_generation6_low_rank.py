#!/usr/bin/env python3
"""Run the deterministic Generation-6 delayed-effect and null contracts."""
...
from th06_rl.low_rank_learning import run_low_rank_causal_smoke  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = run_low_rank_causal_smoke(threads=args.threads)
    ...
    print(json.dumps({
        ...
        "member_mean_effects": report["member_mean_effects"],
