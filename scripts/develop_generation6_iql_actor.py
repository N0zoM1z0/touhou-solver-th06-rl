#!/usr/bin/env python3
"""Cross-fit the action-centered IQL actor on frozen development Wine."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    representation = fit_hazard_codebook(samples, seed=490_813)
    ...
    result = {
        "schema": "autonomous-generation-6-iql-actor-development-v1",
    ...
    print(json.dumps({
        ...
        "proposal_actions": report["proposal_actions"],
    }, sort_keys=True))
    return 0
